...
import { closeDeleteLeaveModal } from "@/redux/modalSlice/employees";
const customStyles = {
  overlay: {
...
const DeleteLeaveModalContent = () => {
  const dispatch = useDispatch();

  const closeDeleteModal = () => {
    document.body.style.overflow = "auto";
    dispatch(closeDeleteLeaveModal());
  };
...
export default DeleteLeaveModalContent;
